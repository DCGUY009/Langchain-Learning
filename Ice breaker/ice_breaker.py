...
Patronage of art
Maharana Pratap's court at Chavand had given shelter to many poets, artists, writers and artisans. The Chavand school of art was developed during the reign of Rana Pratap. He also had renowned artists like Nasiruddin in his court.[24]
...
Death
Reportedly, Pratap died of injuries sustained in a hunting accident,[28] at Chavand[25] on 19 January 1597, aged 56.[29] He was succeeded by his eldest son, Amar Singh I. On his death bed, Pratap told his son never to submit to the Mughals and to win Chittor back.[30]

It is said that even Akbar was shocked to hear the news of Maharana Pratap's death. Dursa Arha, the court poet of Akbar, is said to have eulogised Maharana Pratap in the Mughal court.[31]
"""
...
if __name__ == '__main__':
    ...
    print(f"The type of summary_prompt_template {type(summary_prompt_template)} \nThe Summary Prompt Template variable: {summary_prompt_template}")
    ...
    print(f"The type of llm: {type(llm)}")
    ...
    print(f"The type of res: {type(res)} \nResult is {res}")
