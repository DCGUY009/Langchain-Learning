...
def lookup(name: str) -> str:
    ...
    tools_for_agent = [
        Tool(
            ...
            description="Useful for when you get the Twitter Page URL"
        )
    ]
...
if __name__ == "__main__":
    twitter_username = lookup(name="Vaishnava Samudrala")
    print(twitter_username)  # If you want to run this file, run it from the Ice breaker Project Folder with 
    # `python -m Agents.twitter_lookup_agent` command because if you directly run it, it's not going to consider tools and the API Keys
