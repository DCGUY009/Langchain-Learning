...
from flask import Flask, render_template, request, jsonify  # Flask is to create the flask application isrender_Templates to render HTML, 
...
@app.route("/")  # Our home page, it's going to load an index.html file we share the path to
def index():
